...
Date: 2023-02-02 16:12:21
LastEditTime: 2023-02-02 16:27:45
LastEditors: xujianrong xujianrong@sutpc.com
Description: 
FilePath: /app/image_merge.py
...
def merge_images(image_dir_path,image_size,image_colnum, output):
    # 获取图片集地址下的所有图片名称
    ...
    image_save_path = output  # 图片转换后的地址
...
if __name__ == '__main__':
    ...
    image_dir_path = r'/workspace/dataset/sutpc_object_detections_datasets/val/VOCdevkitszcity1_specialcar_sub2/VOC2007/JPEGImages'  # 图片集地址
    output = "./merge.jpg"
    image_size = 128  # 每张小图片的大小
    image_colnum = 64  # 合并成一张图后，一行有几个小图
    merge_images(image_dir_path, image_size, image_colnum, output)
