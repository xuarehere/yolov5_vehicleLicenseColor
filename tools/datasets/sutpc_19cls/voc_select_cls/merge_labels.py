...
LastEditTime: 2023-01-05 16:25:29
...
def img2xml_paths(img_paths):
    ...
    # img_paths[0]= '../coco128/images/train2017/000000000443.jpg'
    # ----------- start: baoao ----------- 
    sa, sb = os.sep + 'JPEGImages' + os.sep, os.sep + 'Annotations' + os.sep  # /images/, /labels/ substrings        # baoao, xujr
    # ----------- end: baoao -----------     
    #               '../coco128/labels/train2017/000000000009.txt'
...
class DataOpts:
    def __init__(self) -> None:
        # label_path = "/workspace/dataset/baoan_jiaolian_add_futian_special_vehicle_count/VOC2007/labels"
        # path = '/workspace/dataset/baoan_jiaolian_add_futian_special_vehicle_count/VOC2007/JPEGImages/'
    ...
    def change_file_to_new_label(self, path, is_print=True):
        ...
        进行 id 转化
            ...
            不在映射列表中，就进行 id 丢弃
        """
        # tmp_label_file = '/workspace/dataset/baoan_jiaolian_add_futian_special_vehicle_count/tmp/2022_05_09_000204.txt'        
        # check_list = ["frame_000367.txt", 
        #             #   "004623.txt", "000763.txt", "000367.txt", "004450.txt", "004451.txt", "003662.jpg", "003663.jpg", "003664.jpg", "003665.jpg", 
        #               ]
    ...
    def change_to_new_labels(self):
        ...
        # # 复制
        # save_dir = "/workspace/dataset/VOCdevkitszcity1_specialcar_addBaoAn_vehicle_count/tmp"
        # for item in rm_list:
        #     for file in item:
...
"""
self.label_files[0]
'/workspace/dataset/baoan_jiaolian_add_futian_special/VOC2007/labels/2022_05_09_000001.txt'
self.img_files[0]
'/workspace/dataset/baoan_jiaolian_add_futian_special/VOC2007/JPEGImages/2022_05_09_000001.jpg'
"""            
